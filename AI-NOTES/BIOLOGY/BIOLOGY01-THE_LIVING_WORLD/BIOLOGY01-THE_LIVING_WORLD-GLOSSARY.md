...
>
> **Importance Key:** 🔥🔥🔥 = Must-know, appears almost every year (Board + NEET) · 🔥🔥 = Frequently tested · 🔥 = Good to know / supporting term.

---

> [!info] Author Citation — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** The abbreviated name of the scientist who first formally described and validly named a species, written immediately after the binomial scientific name.
> **Anatomical Location / Occurrence:** Appears at the end of a fully written scientific name; e.g., **Linn.** in *Mangifera indica* Linn., indicating Linnaeus first described mango.
...
> [!info] Biodiversity (Greek: *bios* = life + Latin *diversitas* = variety) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** The total number and variety of living organisms present on Earth, encompassing genetic, species, and ecosystem-level variation.
> **Anatomical Location / Occurrence:** A global-scale metric; currently estimated at 1.7–1.8 million formally described species, with new species continuously identified.
...
> [!info] Class (Latin: *classis* = division, group) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** A taxonomic category comprising a group of related orders, sharing broader anatomical or physiological commonalities than order-level groupings.
> **Anatomical Location / Occurrence:** Sits between Phylum/Division and Order; e.g., Mammalia unites Primata and Carnivora.

---

> [!info] Classification (Latin: *classis* = division + *facere* = to make) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** The process by which organisms are grouped into convenient categories (taxa) based on readily observable, shared characteristics, easing the study of otherwise unmanageable biodiversity.
> **Anatomical Location / Occurrence:** Applied universally across the entire tree of life, forming the conceptual basis of the taxonomic hierarchy.
...
> [!info] Identification (Latin: *idem* = same + *facere* = to make) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** The process of correctly describing an organism's structural and biological characteristics such that it can be reliably matched to a defined taxon and, subsequently, named.
> **Anatomical Location / Occurrence:** The necessary preliminary step preceding nomenclature for any organism.

---

> [!info] Kingdom (Old English: *cyning* = king + *dom* = domain) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** The highest and broadest taxonomic category in classical classification, encompassing all phyla (animals) or all divisions (plants) under one umbrella.
> **Anatomical Location / Occurrence:** The topmost rank of the taxonomic hierarchy; e.g., Kingdom Animalia, Kingdom Plantae.
...
> [!info] Notochord (Greek: *noton* = back + Latin *chorda* = cord) — [Exam Target: NEET] 🔥🔥
> **Scientific Definition:** A flexible, rod-shaped structure running along the dorsal axis of an organism, used as a key diagnostic feature for inclusion in phylum Chordata.
> **Anatomical Location / Occurrence:** Present in all members of phylum Chordata, alongside a dorsal hollow neural system, distinguishing them from non-chordate phyla.

---

> [!info] Order (Latin: *ordo* = row, rank, arrangement) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** A taxonomic category formed from an assemblage of families exhibiting a smaller number of shared characteristics compared to the similarities within a family.
> **Anatomical Location / Occurrence:** Sits between Class and Family; e.g., Carnivora unites Felidae and Canidae.
...
> [!info] Taxon (plural: Taxa) (Greek: *taxis* = arrangement) — [Exam Target: Both] 🔥🔥
> **Scientific Definition:** A unit or category of biological classification representing a specific rank in the taxonomic hierarchy (e.g., Kingdom, Phylum, Class). Each taxon is a distinct biological entity, not a mere morphological aggregate.
> **Anatomical Location / Occurrence:** Exists at every level of the taxonomic hierarchy — from the broadest (Kingdom) to the narrowest (Species) — across both plant and animal classification systems.
...
## 📋 QUICK A–Z INDEX (for instant lookup)

Author Citation → Binomial Nomenclature → Biodiversity → Carolus Linnaeus → Class → Classification → Dicotyledonae & Monocotyledonae → Division → Family → Generic Name → Genus → ICBN → ICZN → Identification → Kingdom → Latinisation → Nomenclature → Notochord → Order → Phylum → Specific Epithet → Species → Systematics → Taxon → Taxonomy

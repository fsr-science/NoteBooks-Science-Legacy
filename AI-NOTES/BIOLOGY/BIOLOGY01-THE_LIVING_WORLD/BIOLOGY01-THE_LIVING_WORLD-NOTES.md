...
```mermaid
flowchart TD
    Root(["Ch. 1 — The Living World"])

    Root --> Div["1.1  Diversity in the Living World"]
    Root --> NameSec["1.1.1–1.1.2  Identification and Nomenclature"]
    Root --> TaxSec["1.2  Taxonomy and Systematics"]
    Root --> HierSec["1.3–1.4  Taxonomic Hierarchy"]

    Div --> D1["1.7–1.8 million species formally described on Earth"]
    Div --> D2["Local names vary — scientific names standardise global communication"]

    NameSec --> N1["ICBN governs plants — ICZN governs animals"]
    NameSec --> N2["Binomial Nomenclature introduced by Carolus Linnaeus"]
    NameSec --> N3["Rules: Latin, italics, Genus capitalised, specific epithet lowercase"]

    TaxSec --> T1["Taxonomy: Characterisation, Identification, Classification, Nomenclature"]
    TaxSec --> T2["Systematics = Taxonomy plus Evolutionary Relationships"]
    TaxSec --> T3["Systematics is broader in scope than Taxonomy"]

    HierSec --> H1["7 Ranks: Kingdom — Phylum or Division — Class — Order — Family — Genus — Species"]
    HierSec --> H2["Ascending the hierarchy: number of shared characteristics decreases"]
    HierSec --> H3["Phylum for Animals only — Division for Plants only"]

    style Root fill:#1e3a5f,color:#e0f0ff,stroke:#4a9eff,stroke-width:3px
    style Div fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style NameSec fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style TaxSec fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style HierSec fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style D1 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style D2 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style N1 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style N2 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style N3 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style T1 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style T2 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71
    style T3 fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c
    style H1 fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c
    style H2 fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c
    style H3 fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c
```
...
flowchart LR
    ...
    E --> F[Classification into taxonomic hierarchy]

    style A fill:#1e3a5f,color:#e0f0ff,stroke:#4a9eff,stroke-width:2px
    style B fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style C fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71,stroke-width:2px
    style D fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style E fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71,stroke-width:2px
    style F fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c,stroke-width:2px
```
...
$$
\underbrace{\textit{Mangifera}} *{\text{Genus}}\ \underbrace{\textit{indica}}* {\text{Specific Epithet}}
$$
...
flowchart TD
    ...
    style Start fill:#1e3a5f,color:#e0f0ff,stroke:#4a9eff,stroke-width:2px
    style Latin fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style Genus fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style Epithet fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style Final fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style R1 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71,stroke-width:2px
    style R2 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71,stroke-width:2px
    style R3 fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71,stroke-width:2px
    style Author fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style Valid fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c,stroke-width:2px
```
...
flowchart TD
    ...
    style Tax fill:#1e3a5f,color:#e0f0ff,stroke:#4a9eff,stroke-width:2px
    style C1 fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style C2 fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style C3 fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style C4 fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style Basis fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c,stroke-width:2px
```
...
flowchart TD
    ...
    style P fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style CL fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style O fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style F fill:#3d2a1a,color:#f0d0a8,stroke:#e67e22,stroke-width:2px
    style G fill:#1a3d2e,color:#a8f0c6,stroke:#2ecc71,stroke-width:2px
    style S fill:#3d1a1a,color:#ffd0d0,stroke:#e74c3c,stroke-width:2px
```

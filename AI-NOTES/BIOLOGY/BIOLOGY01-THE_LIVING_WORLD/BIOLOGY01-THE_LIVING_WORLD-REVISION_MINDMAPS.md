...
```mermaid
graph TD
    Kingdom["KINGDOM"] --> PhylumDiv["PHYLUM / DIVISION"]
    PhylumDiv --> Class["CLASS"]
    Class --> Order["ORDER"]
    Order --> Family["FAMILY"]
    Family --> Genus["GENUS"]
    Genus --> Species["SPECIES"]

    Species -.->|"Man"| ManEx["Homo sapiens"]
    Species -.->|"Housefly"| FlyEx["Musca domestica"]
    Species -.->|"Mango"| MangoEx["Mangifera indica"]
    Species -.->|"Wheat"| WheatEx["Triticum aestivum"]

    style Kingdom fill:#fecaca,stroke:#ef4444,stroke-width:2px
    style PhylumDiv fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Class fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Order fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Family fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Genus fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
    style Species fill:#86efac,stroke:#16a34a,stroke-width:2px
    style ManEx fill:#dbeafe,stroke:#3b82f6,stroke-width:1px
    style FlyEx fill:#dbeafe,stroke:#3b82f6,stroke-width:1px
    style MangoEx fill:#dbeafe,stroke:#3b82f6,stroke-width:1px
    style WheatEx fill:#dbeafe,stroke:#3b82f6,stroke-width:1px
```
...
```mermaid
graph TD
    FelidaeFam["Family: Felidae"] --> Panthera["Genus: Panthera"]
    FelidaeFam --> Felis["Genus: Felis"]
    Panthera --> Lion["leo (Lion)"]
    Panthera --> Tiger["tigris (Tiger)"]
    Panthera --> Leopard["pardus (Leopard)"]
    Felis --> Cat["Domestic Cat"]

    CanidaeFam["Family: Canidae"] --> DogGenus["Genus: Canis"]

    Carnivora["Order: Carnivora"] --> FelidaeFam
    Carnivora --> CanidaeFam

    style FelidaeFam fill:#fef08a,stroke:#eab308,stroke-width:2px
    style CanidaeFam fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Panthera fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
    style Felis fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
    style DogGenus fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
    style Lion fill:#86efac,stroke:#16a34a,stroke-width:1px
    style Tiger fill:#86efac,stroke:#16a34a,stroke-width:1px
    style Leopard fill:#86efac,stroke:#16a34a,stroke-width:1px
    style Cat fill:#86efac,stroke:#16a34a,stroke-width:1px
    style Carnivora fill:#fecaca,stroke:#ef4444,stroke-width:2px
```
